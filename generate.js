...
const pages = {
  index: {
    ...
    content: `
      <section class="hero" style="position: relative; display: flex; align-items: center; justify-content: center; min-height: 85vh; text-align: center; color: #FFF; background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.7)), url('https://static.wixstatic.com/media/13d483_4deecc5fe87d43a38f80e11855ed6e4d~mv2.jpg/v1/fill/w_1920,h_1080,al_c,q_90/file.jpg'); background-size: cover; background-position: center; background-attachment: fixed;">
        <div class="container" style="position: relative; z-index: 2;">
          <div class="hero-content" style="max-width: 900px; margin: 0 auto; padding: 40px;">
            ...
            <h1 class="hero-title reveal delay-1" style="font-size: 72px; font-weight: 700; line-height: 1.2; letter-spacing: 4px; color: #FFF; text-shadow: 0 4px 20px rgba(0,0,0,0.5);">宇禾建材<br><span style="font-size: 32px; font-weight: 400; display: block; margin-top: 16px; letter-spacing: 2px; color: rgba(255,255,255,0.9);">您專業建築工程的頂尖合作夥伴</span></h1>
      ...
      <!-- Scrollable Content 1.5: Project Showcase -->
      <section class="section" style="padding: 0; background-color: var(--color-primary); color: #FFF; overflow: hidden;">
        <div class="grid-2" style="gap: 0; align-items: stretch;">
          <div class="reveal" style="padding: 100px 80px; display: flex; flex-direction: column; justify-content: center;">
            <span class="section-subtitle" style="color: rgba(255,255,255,0.5);">Design Inspiration</span>
            <h2 class="section-title" style="color: #FFF;">極致美學的空間展現</h2>
            <div class="divider" style="background-color: var(--color-accent);"></div>
            <p style="color: rgba(255,255,255,0.7); margin-bottom: 24px;">頂級建材不僅是建築的骨幹，更是空間美學的靈魂。透過高品質的磁磚與精準的填縫工藝，我們協助設計師與建築師將每一個光影細節完美呈現。</p>
            <p style="color: rgba(255,255,255,0.7); margin-bottom: 40px;">圖中展示了結合深色立體磁磚與石材檯面的頂級衛浴空間，展現出洗鍊而奢華的現代風格。</p>
            <div>
              <a href="products.html" class="btn btn-outline" style="border-color: rgba(255,255,255,0.3); color: #FFF;">探索建材</a>
            </div>
          </div>
          <div class="reveal delay-2" style="position: relative; min-height: 600px;">
            <div style="position: absolute; inset: 0; background-image: url('showcase.jpg'); background-size: cover; background-position: center; border-left: 1px solid rgba(255,255,255,0.1);"></div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          ...
          <div class="grid-3">
            <div class="product-card reveal delay-1">
              <div style="text-align: center;"><img src="https://static.wixstatic.com/media/13d483_85a0bbcd800b42ae867a7d2fc0bfa25a~mv2.jpg/v1/fit/w_500,h_500,q_90/file.jpg" loading="lazy" style="width: 100%; height: 220px; object-fit: contain; margin-bottom: 24px;"></div>
            ...
            <div class="product-card reveal delay-2">
              <div style="text-align: center;"><img src="https://static.wixstatic.com/media/13d483_9706aa16a95a44fb89778eb01a4d1f8e~mv2.jpg/v1/fit/w_500,h_500,q_90/file.jpg" loading="lazy" style="width: 100%; height: 220px; object-fit: contain; margin-bottom: 24px;"></div>
            ...
            <div class="product-card reveal delay-3">
              <div style="text-align: center;"><img src="https://static.wixstatic.com/media/13d483_5ffd7fae088a4349a107155f17cc42bf~mv2.jpg/v1/fit/w_500,h_500,q_90/file.jpg" loading="lazy" style="width: 100%; height: 220px; object-fit: contain; margin-bottom: 24px;"></div>
      ...
      <section class="section bg-light">
        <div class="container">
          ...
          <div class="grid-3">
            ...
            <div class="product-card">
              <div style="text-align: center;"><img src="https://static.wixstatic.com/media/13d483_f34d1cf9584a4eb18dc21833a1cb0de6~mv2.jpg/v1/fit/w_500,h_500,q_90/file.jpg" loading="lazy" style="width: 100%; height: 220px; object-fit: contain; margin-bottom: 24px;"></div>
              <span class="product-category">Grouts</span>
              <h3 class="product-title" style="font-size: 16px;">SikaCeram®-650Classic<br>抗菌防霉水泥填縫劑</h3>
              <a href="contact.html" class="product-link">Request Details</a>
            </div>
            <div class="product-card">
              <div style="text-align: center;"><img src="https://static.wixstatic.com/media/13d483_031e0939d7034f33a6ebe5fdeafb313c~mv2.jpg/v1/fit/w_500,h_500,q_90/file.jpg" loading="lazy" style="width: 100%; height: 220px; object-fit: contain; margin-bottom: 24px;"></div>
            ...
            <div class="product-card">
              <div style="text-align: center;"><img src="https://static.wixstatic.com/media/13d483_1a71f1010655484590153108fef97984~mv2.jpg/v1/fit/w_500,h_500,q_90/file.jpg" loading="lazy" style="width: 100%; height: 220px; object-fit: contain; margin-bottom: 24px;"></div>
              <span class="product-category">Primer</span>
              <h3 class="product-title" style="font-size: 16px;">SikaTop®-50<br>多孔系水性底漆</h3>
              <a href="contact.html" class="product-link">Request Details</a>
            </div>
            <div class="product-card">
              <div style="text-align: center;"><img src="https://static.wixstatic.com/media/13d483_e1111090360947a4a35e7bb7c7d68cc3~mv2.jpg/v1/fit/w_500,h_500,q_90/file.jpg" loading="lazy" style="width: 100%; height: 220px; object-fit: contain; margin-bottom: 24px;"></div>
            ...
            <div class="product-card">
              <div style="text-align: center;"><img src="https://static.wixstatic.com/media/13d483_3aa30d8d13ee4c2cbbeb57e5746cb14c~mv2.jpg/v1/fit/w_500,h_500,q_90/file.jpg" loading="lazy" style="width: 100%; height: 220px; object-fit: contain; margin-bottom: 24px;"></div>
              <span class="product-category">Adhesives</span>
              <h3 class="product-title" style="font-size: 16px;">SikaCeram®-188 MY<br>馬來西亞進口高性能磁磚黏著劑</h3>
              <a href="contact.html" class="product-link">Request Details</a>
            </div>
            <div class="product-card">
              <div style="text-align: center;"><img src="https://static.wixstatic.com/media/13d483_55b636a0bf224dc798c392885abbc623~mv2.jpg/v1/fit/w_500,h_500,q_90/file.jpg" loading="lazy" style="width: 100%; height: 220px; object-fit: contain; margin-bottom: 24px;"></div>
              <span class="product-category">Adhesives</span>
  ...
  contact: {
    ...
    content: `
      ...
      <div style="width: 100%; height: 500px; line-height: 0;">
        <iframe loading="lazy" width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=302新竹縣竹北市自強五路253號&t=&z=15&ie=UTF8&iwloc=&output=embed" style="filter: grayscale(100%) contrast(1.2);"></iframe>
      </div>
    `
  }
};
